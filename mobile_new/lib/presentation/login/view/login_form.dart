...
import 'package:very_good_rx_blog_app/presentation/widgets/filled_button.dart';
import 'package:very_good_rx_blog_app/presentation/widgets/text_field_decoration.dart';
import 'package:very_good_rx_blog_app/presentation/widgets/title_of_text_field.dart';
            ...
            decoration: InputDecoration(
              ...
              suffixIcon: IconButton(
                icon: _isHidePassword
                    ? Assets.icons.show.svg(color: context.colorScheme.primary)
                    : Assets.icons.hide.svg(color: context.colorScheme.primary),
                onPressed: () {
                  setState(() {
